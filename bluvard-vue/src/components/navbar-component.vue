    ...
    <div class="relative bg-white">
      ...
      <div class="flex justify-between items-center max-w-7xl mx-auto px-4 py-6 sm:px-6 md:justify-start md:space-x-10 lg:px-8">
        ...
        <div class="-mr-2 -my-2 sm:hidden">
          <button @click="menuOpen = !menuOpen" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500" aria-expanded="false">
        ...
        <nav class="hidden sm:flex space-x-10 ">
          ...
          <div class="relative">
            ...
            <button @click="menuOpen=!menuOpen" type="button" class="text-gray-500 group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-gray-900 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500" aria-expanded="false">
            ...
            <div :class="{hidden:menuOpen}" class="absolute z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-2xl lg:ml-0 lg:left-1/2 lg:-translate-x-1/2">
          ...
          <router-link to="/event" class="text-base font-medium text-gray-500 hover:text-gray-900"> Events </router-link>

          <router-link to="/contact" class="text-base font-medium text-gray-500 hover:text-gray-900"> Contact </router-link>
        ...
        <div class="hidden sm:flex items-center justify-end md:flex-1 lg:w-0">
          ...
          <a href="#" class="ml-8 whitespace-nowrap inline-flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Volunteer </a>
        </div>
      </div>
      <!-- mobile navbar -->
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          <div class="pt-5 pb-6 px-5">
            <div class="flex items-center justify-between mb-8">
              <div>
                <img class="h-10 w-auto" src="../assets/Bluvard_svg_logo.svg" alt="Workflow">
              </div>
              <div class="-mr-2">
                <button @click="menuOpen=!menuOpen" type="button" class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
          ...
          <div class="py-6 px-5">
            <div class="grid grid-cols-2 gap-4">
              ...
              <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Sponsors </a>

              <a href="#" class="text-base font-medium text-gray-900 hover:text-gray-700"> Bluvard News </a>
            </div>
            <div class="mt-6">
              <a href="#" class="w-full flex items-center justify-center px-4 py-2 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-indigo-600 hover:bg-indigo-700"> Volunteer </a>
            </div>
          </div>
        </div>
      </div>
