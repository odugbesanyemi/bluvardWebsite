  ...
  <div class="mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        ...
        <p>Bluvard Education initiative</p>
        </div>

        <p
          class="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500 sm:mx-0 sm:max-w-xs sm:text-left"
        >
        <!-- If Quality education is not just a basic human right but also fundamental in closing the gaps created by inequality, and ultimately reducing global poverty, 
        how then do we democratize access to quality education for young people in rural communities across Nigeria? -->
        </p>
          ...
          <ul class="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span class="text-gray-700">hello@bluvard.com</span>
              </a>
            </li>
            ...
            <li>
              ...
              >
                ...
                <span class="text-gray-700">+234 XXXXXXXXXX</span>
              </a>
            </li>
