...
<template>
  <footer aria-label="Site Footer" class="bg-white">
    <div class="">
      ...
      <div class="mt-12 border-t border-gray-100 py-6">
        <div
          class="text-center sm:flex sm:justify-between sm:text-left sm:flex-row mx-auto max-w-screen-xl px-4 sm:px-6 lg:px-8 ">
