    ...
    <div class="relative bg-gray-800">
      ...
      <div class="relative max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8 lg:py-16">
        <div class="md:ml-auto md:w-1/2 md:pl-10">
          <h2 class=" tracking-wider text-gray-300">We can't manage all these ourselves</h2>
          <p class="mt-2 text-white text-3xl font-bold tracking-tight sm:text-4xl">Care to help?</p>
